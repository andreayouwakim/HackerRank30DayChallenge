...
(scaled to  decimal place) on the second line, and then the two concatenated strings on the third line.
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        int for_i = scan.nextInt();
        double for_d = scan.nextDouble();
        scan.nextLine();
        String for_s = scan.nextLine();
        ...
        /* Print the sum of the double variables on a new line. */
		    System.out.println(for_d + d);
        /* Concatenate and print the String variables on a new line; 
        	the 's' variable above should be printed first. */
        System.out.println(s + for_s);
        scan.close();
    }
}
