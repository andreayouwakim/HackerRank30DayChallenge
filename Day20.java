/**
 *Objective 
 Link to the problem : https://www.hackerrank.com/challenges/30-sorting?h_r=next-challenge&h_v=zen
...
Hint: To complete this challenge, you will need to add a variable that keeps a running 
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        // Track number of elements swapped during a single array traversal
            ...
            // Swap adjacent elements if they are in decreasing order
                if(a[j] > a[j + 1]){
                  // the ole java switcheroo
                  int temp = a[j] ;
                  a[j] = a[j + 1];
                  a[ j + 1] = temp;
                  // count a current swap
                  numberOfSwaps++;
                }
            }
          // keep running tally of total swaps
